...
import smk.adzikro.moviezone.objek.About
import smk.adzikro.moviezone.objek.ListAbout
...
class AboutActivity : AppCompatActivity() {
    ...
    fun init(){
       ...
       textView.text = String.format(getString(R.string.about), versi)
        recyclerView.apply {
   ...
   inner class HolderAbout(view: View):RecyclerView.ViewHolder(view){
        ...
        fun bind(about: ListAbout, copy :View.OnClickListener){
            imageView.setImageResource(img[about.about?.id!!])
